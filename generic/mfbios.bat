...
gccmvs -Os -U__MVS__ -DNEED_MVS -D__MF32__ -D__ZPDOSGPB__ -DUSE_MEMMGR -S -I . -I ../pdpclib -I ../bios bios.c
gccmvs -Os -U__MVS__ -DNEED_MVS -D__MF32__ -D__ZPDOSGPB__ -DUSE_MEMMGR -S -I . -I ../pdpclib -I ../bios ../bios/exeload.c
